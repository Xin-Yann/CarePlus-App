...
class PharmacyLogin extends StatefulWidget {
  ...
  @override
  State<PharmacyLogin> createState() => _LoginPharmacy();
}

class _LoginPharmacy extends State<PharmacyLogin> {
  ...
  Future<void> _loginPharmacy() async {
    ...
    bool isPharmacyEmail = email.text.trim().endsWith('@pharmacy.com');
