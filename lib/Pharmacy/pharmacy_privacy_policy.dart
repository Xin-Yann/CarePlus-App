...
class PharmacyPrivacyPolicy extends StatefulWidget {
  const PharmacyPrivacyPolicy({Key? key}) : super(key: key);

  @override
  State<PharmacyPrivacyPolicy> createState() => _PharmacyPrivacyPolicyState();
}

class _PharmacyPrivacyPolicyState extends State<PharmacyPrivacyPolicy> {
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Text(
              '1. We collect your name, contact, email, operation hours, address, and profile image.',
