      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Text(
              "2.To fulfill shipping services, CarePlus may share users' shipping information with third-party shipping providers.",
              style: TextStyle(fontSize: 16, color: Colors.black),
              softWrap: true,
            ),
          ),
          ...
          Padding(
            ...
            child: Text(
              '5. CarePlus may request access to device location for features such as locating nearby pharmacy. Users can control location-sharing preferences in the app settings.',
              style: TextStyle(fontSize: 16, color: Colors.black),
              softWrap: true,
            ),
          ),
          ...
          Padding(
            ...
            child: Text(
              '6. Users acknowledge that third-party shipping providers have their own terms and conditions, and CarePlus is not responsible for the practices of these third parties.',
              style: TextStyle(fontSize: 16, color: Colors.black),
              softWrap: true,
            ),
          ),
